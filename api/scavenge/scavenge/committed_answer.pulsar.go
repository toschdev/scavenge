...
type fastReflection_CommittedAnswer CommittedAnswer

func (x *CommittedAnswer) ProtoReflect() protoreflect.Message {
	return (*fastReflection_CommittedAnswer)(x)
}

func (x *CommittedAnswer) slowProtoReflect() protoreflect.Message {
	mi := &file_scavenge_scavenge_committed_answer_proto_msgTypes[0]
...
var _fastReflection_CommittedAnswer_messageType fastReflection_CommittedAnswer_messageType
var _ protoreflect.MessageType = fastReflection_CommittedAnswer_messageType{}

type fastReflection_CommittedAnswer_messageType struct{}

func (x fastReflection_CommittedAnswer_messageType) Zero() protoreflect.Message {
	return (*fastReflection_CommittedAnswer)(nil)
}
func (x fastReflection_CommittedAnswer_messageType) New() protoreflect.Message {
	return new(fastReflection_CommittedAnswer)
}
func (x fastReflection_CommittedAnswer_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_CommittedAnswer
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_CommittedAnswer) Descriptor() protoreflect.MessageDescriptor {
	return md_CommittedAnswer
}
...
func (x *fastReflection_CommittedAnswer) Type() protoreflect.MessageType {
	return _fastReflection_CommittedAnswer_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_CommittedAnswer) New() protoreflect.Message {
	return new(fastReflection_CommittedAnswer)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_CommittedAnswer) Interface() protoreflect.ProtoMessage {
	return (*CommittedAnswer)(x)
}
...
func (x *fastReflection_CommittedAnswer) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		...
		panic(fmt.Errorf("message scavenge.scavenge.CommittedAnswer does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_CommittedAnswer) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message scavenge.scavenge.CommittedAnswer does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_CommittedAnswer) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in scavenge.scavenge.CommittedAnswer", d.FullName()))
	}
	panic("unreachable")
}
...
func (x *fastReflection_CommittedAnswer) GetUnknown() protoreflect.RawFields {
...
func (x *fastReflection_CommittedAnswer) SetUnknown(fields protoreflect.RawFields) {
...
func (x *fastReflection_CommittedAnswer) IsValid() bool {
	return x != nil
}
...
func (x *fastReflection_CommittedAnswer) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*CommittedAnswer)
		if x == nil {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: CommittedAnswer: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: CommittedAnswer: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 0 {
...
func (x *CommittedAnswer) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CommittedAnswer) ProtoMessage() {}

// Deprecated: Use CommittedAnswer.ProtoReflect.Descriptor instead.
...
func (x *CommittedAnswer) GetHashAnswer() string {
	if x != nil {
		return x.HashAnswer
	}
	return ""
...
var file_scavenge_scavenge_committed_answer_proto_rawDesc = []byte{
	0x0a, 0x28, 0x73, 0x63, 0x61, 0x76, 0x65, 0x6e, 0x67, 0x65, 0x2f, 0x73, 0x63, 0x61, 0x76, 0x65,
...
var (
	file_scavenge_scavenge_committed_answer_proto_rawDescOnce sync.Once
	file_scavenge_scavenge_committed_answer_proto_rawDescData = file_scavenge_scavenge_committed_answer_proto_rawDesc
)

func file_scavenge_scavenge_committed_answer_proto_rawDescGZIP() []byte {
	file_scavenge_scavenge_committed_answer_proto_rawDescOnce.Do(func() {
		file_scavenge_scavenge_committed_answer_proto_rawDescData = protoimpl.X.CompressGZIP(file_scavenge_scavenge_committed_answer_proto_rawDescData)
	})
	return file_scavenge_scavenge_committed_answer_proto_rawDescData
}

var file_scavenge_scavenge_committed_answer_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_scavenge_scavenge_committed_answer_proto_goTypes = []interface{}{
	(*CommittedAnswer)(nil), // 0: scavenge.scavenge.CommittedAnswer
}
var file_scavenge_scavenge_committed_answer_proto_depIdxs = []int32{
...
func init() { file_scavenge_scavenge_committed_answer_proto_init() }
func file_scavenge_scavenge_committed_answer_proto_init() {
	if File_scavenge_scavenge_committed_answer_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_scavenge_scavenge_committed_answer_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CommittedAnswer); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_scavenge_scavenge_committed_answer_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_scavenge_scavenge_committed_answer_proto_goTypes,
		DependencyIndexes: file_scavenge_scavenge_committed_answer_proto_depIdxs,
		MessageInfos:      file_scavenge_scavenge_committed_answer_proto_msgTypes,
	}.Build()
	File_scavenge_scavenge_committed_answer_proto = out.File
	file_scavenge_scavenge_committed_answer_proto_rawDesc = nil
	file_scavenge_scavenge_committed_answer_proto_goTypes = nil
	file_scavenge_scavenge_committed_answer_proto_depIdxs = nil
}
