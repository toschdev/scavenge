...
func (m *ScavengeQuestion) GetId() uint64 {
	if m != nil {
		return m.Id
	}
	return 0
...
var fileDescriptor_11be4d0e5138a629 = []byte{
	...
	,
}
...
func (m *ScavengeQuestion) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Id != 0 {
		i = encodeVarintScavengeQuestion(dAtA, i, uint64(m.Id))
		i--
		dAtA[i] = 0x8
	}
...
func (m *ScavengeQuestion) Size() (n int) {
	...
	_ = l
	if m.Id != 0 {
		n += 1 + sovScavengeQuestion(uint64(m.Id))
	}
	l = len(m.Creator)
	if l > 0 {
